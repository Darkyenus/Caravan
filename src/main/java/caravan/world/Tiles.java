...
public final class Tiles {
	...
	public static final Tile Forest = overlapTile(10, "forest", 0.7f);
	public static final Tile Grass = overlapTile(2, "grass", 1f);
	public static final Tile Desert = overlapTile(3, "desert", 0.8f);
	public static final Tile Rock = overlapTile(0, "rock", 0.4f);
